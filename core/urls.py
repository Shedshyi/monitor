...
from .views import (
    ...
    RecalculateScoresView, NotificationListView,RegisterView, LoginView, MyScoresView, UserDetailView,TopTeachersView,AchievementsListView,FilteredTeachersView,BestTeachersView
)
...
urlpatterns = [
    ...
    path('best-teachers/', BestTeachersView.as_view(), name='best-teachers'),
]
